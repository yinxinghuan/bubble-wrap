...
- 游戏：Bubble Wrap
- 类型：casual
- 简述：气泡膜 — 戳爆每一颗都会回弹补充，三种主题：星云、蜂蜜、彩虹皂泡
...
- 平台元信息：meta.title=Bubble Wrap；cover_url=/poster.png；category=casual；uuid=768fc21f-d730-4015-acaf-355e9bf7bf60
...
- `src/BubbleWrap/BubbleWrap.tsx`
- `src/BubbleWrap/index.ts`
- `src/BubbleWrap/BubbleWrap.less`
